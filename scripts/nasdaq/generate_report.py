...
使用 GenerateNasdaqDashboardTool 生成包含 MA24、RSI 和偏离度分析的交互式看板
"""
import sys
...
def main():
    """主函数"""
    print("\n" + "=" * 60)
    print("NASDAQ 技术分析看板生成器")
    print("=" * 60)
    print()
    
    registry = get_default_registry()
    tool = registry.get('generate_nasdaq_dashboard')
    
    if not tool:
        print("✗ 未找到 generate_nasdaq_dashboard 工具")
        return 1
